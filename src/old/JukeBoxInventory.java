...
public class JukeBoxInventory implements Listener
{
    ...
    static {
        ...
        JukeBoxInventory.toggleItem = item( Material.END_CRYSTAL , Lang.TOGGLE_PLAYING, new String[0]);
        JukeBoxInventory.randomItem = item(Material.FIRE_CHARGE , Lang.RANDOM_MUSIC, new String[0]);
        JukeBoxInventory.playlistMenuItem = item(Material.CHEST, Lang.PLAYLIST_ITEM, new String[0]);
        JukeBoxInventory.optionsMenuItem = item(Material.COMPARATOR, Lang.OPTIONS_ITEM, new String[0]);
        ...
        JukeBoxInventory.particles = Material.FIREWORK_ROCKET;
        JukeBoxInventory.sign =  Material.OAK_SIGN;
        JukeBoxInventory.lead =  Material.LEAD;
        ...
        radioItem = new ItemBuilder(Material.PLAYER_HEAD)
                ...
                .headTexture("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMTQ4YThjNTU4OTFkZWM3Njc2NDQ0OWY1N2JhNjc3YmUzZWU4OGEwNjkyMWNhOTNiNmNjN2M5NjExYTdhZiJ9fX0=")
                .build();
    ...
    public JukeBoxInventory(final Player p) {
        ...
        for (int i = 0; i < this.discs.length; ++i) {
            this.discs[i] = Material.valueOf(JukeBoxInventory.discs13.get(ran.nextInt(12)));
        }
